...
public class TestData {
	...
	public void libraryMemberData() {
		...
		members.add(libraryMember);
		libraryMember = new LibraryMember("1", "Ricardo", "Montalbahn", "641-472-2871", addresses.get(7));
		members.add(libraryMember);
	...
	List<Book> allBooks = new ArrayList<Book>() {
		{
			...
			add(new Book("11-111", "Mpp", 7, Arrays.asList(allAuthors.get(4))));
			add(new Book("2", "Programming", 21, Arrays.asList(allAuthors.get(4))));
		}
	};
	...
	List<User> allUsers = new ArrayList<User>() {
		{
			...
			// Custom user
			add(new User("1", "111", Auth.ADMIN));
			add(new User("2", "222", Auth.LIBRARIAN));
			add(new User("3", "333", Auth.BOTH));
